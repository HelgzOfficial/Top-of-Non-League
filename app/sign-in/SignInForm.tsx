...
export default function SignInForm() {
  ...
  async function sendCode(e: React.FormEvent) {
    ...
    // Carry a private-league invite's "next" (e.g. /leagues?join=CODE)
    // through to the verify step, and from there through setup, so it
    // survives the whole sign-up funnel instead of getting lost.
