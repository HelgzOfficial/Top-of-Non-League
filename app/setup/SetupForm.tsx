...
// Only ever treat "next" as a redirect target if it's a path on this same
// site (starts with a single "/", not "//" which browsers treat as
// protocol-relative and would send someone off-site) — this is a
// user-suppliable query param, so it shouldn't be trusted blindly.
...
export default function SetupForm() {
  ...
  async function finishSetup(e: React.FormEvent) {
    ...
    // Lands a brand new user who came from a private-league invite link
    // straight back at /leagues with the join code already filled in,
    // instead of dropping them on /home with no idea what to do next.
