...
export default async function TablePage() {
  ...
  return (
    <div className="px-4 pt-6">
      <div className="mb-4">
        <h3 className="font-extrabold text-[15px]">League table</h3>
        <p className="text-xs text-sub mt-0.5">Top of Non League · Isthmian Premier</p>
      </div>
      ...
      <div className="card !p-4">
        ...
        {standings.length === 0 && <p className="text-sub text-sm py-3 text-center">No one&apos;s joined yet.</p>}
      </div>
